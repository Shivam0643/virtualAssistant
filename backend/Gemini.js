...
"userInput": "<original user input>" {only remove your name from userinput 
    if exists} and agar kisi ne google ya youtube pe kuch search karne ko bola hai to
...
hai usko bhi general ki category mai rakho bas short answer dena.
...
- "get-date": if user asks for today's day.
- "get-day": if user asks what day it is.
- "get-month": if user asks fot the current month.
